...
const App = () => (
  <Routes>
    ...
    <Route path="/hub-5" element={<h1>hub-5</h1>}></Route>
    <Route path="/hub-6" element={<h1>hub-6</h1>}></Route>
    <Route path="/hub-7" element={<h1>hub-7</h1>}></Route>
    <Route path="/hub-8" element={<h1>hub-8</h1>}></Route>
    <Route path="/hub-9" element={<h1>hub-9</h1>}></Route>
    <Route path="/hub-10" element={<h1>hub-10</h1>}></Route>
    <Route path="/business-1" element={<h1>business</h1>}></Route>
    <Route path="/business-2" element={<h1>business</h1>}></Route>
    <Route path="/business-3" element={<h1>business</h1>}></Route>
    <Route path="/business-4" element={<h1>business</h1>}></Route>
    <Route path="/business-5" element={<h1>business</h1>}></Route>
